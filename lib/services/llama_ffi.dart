...
typedef LoadModelNative = Pointer<LlamaOpaque> Function(Pointer<Utf8> modelPath);
typedef PredictNative = Pointer<Utf8> Function(Pointer<LlamaOpaque> context, Pointer<Utf8> prompt);
...
typedef PredictDart = Pointer<Utf8> Function(Pointer<LlamaOpaque> context, Pointer<Utf8> prompt);
